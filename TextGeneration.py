...
for i in range(0, characters_count - sequence_length, 1):
    sequence_input = words[i : i + sequence_length]
    sequence_output = words[i + sequence_length]
...
if(is_training):
    ...
    filepath=src_file_path + "/weights/" + "parme-{loss:.4f}-{epoch:02d}.hdf5"
